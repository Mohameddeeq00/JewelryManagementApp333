...
namespace JewelryManagementApp.Controllers
{
    public class ShopsController : Controller
    {
        ...
        public ShopsController(JewelryManagementDb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ShopId,Name,Location,ContactInfo")] Shop shop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShopId,Name,Location,ContactInfo")] Shop shop)
        {
            if (id != shop.ShopId)
            {
                return NotFound();
